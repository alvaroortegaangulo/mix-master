...
def _apply_limiter(
    ...
    # Forzamos ceiling un poco más bajo (-0.1 extra) para compensar posibles ISPs
    # que Pedalboard no atrape si no está en modo True Peak.
    safe_ceiling = min(float(ceiling_dbtp), -0.1)
