        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-slate-900/50 rounded-3xl border border-slate-800 p-6 flex flex-col justify-between min-h-[500px] shadow-2xl relative overflow-hidden">
             ...
             <div className="flex justify-between items-start mb-8 relative z-10">
                 ...
                 <div className="text-xs font-mono text-slate-400 pt-2">20Hz - 20kHz</div>
             </div>
             ...
             <div className="grid grid-cols-3 gap-4 border-t border-slate-800 pt-6 relative z-10">
                 <div>
                     <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400 mb-1">Low End (Sub)</div>
                     <div className="text-white font-medium">Balanced</div>
                 </div>
                 <div>
                     <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400 mb-1">Vocal Presence</div>
                     <div className="text-teal-400 font-medium">Optimal</div>
                 </div>
                 <div className="text-right">
                     <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400 mb-1">Air / Shine</div>
          ...
          <div className="flex flex-col gap-4">
             ...
             <div className="bg-slate-900/50 rounded-2xl border border-slate-800 p-6 shadow-lg relative group overflow-hidden">
                <div className="flex justify-between items-start mb-2">
                    <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400">Integrated Loudness</div>
                ...
                <div className="text-4xl font-bold text-white mb-1 tabular-nums tracking-tight">
                    {lufs.toFixed(1)} <span className="text-lg font-normal text-slate-400">LUFS</span>
                </div>
             ...
             <div className="bg-slate-900/50 rounded-2xl border border-slate-800 p-6 shadow-lg relative overflow-hidden">
                 <div className="flex justify-between items-start">
                     <div>
                        <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400 mb-1">Stereo Image</div>
                 ...
                 <p className="text-xs text-slate-400 leading-relaxed border-t border-slate-800/50 pt-3 mt-1">
             ...
             <div className="bg-slate-900/50 rounded-2xl border border-slate-800 p-6 shadow-lg flex items-center justify-between">
                 <div>
                    <div className="text-[10px] font-mono uppercase tracking-wider text-slate-400 mb-1">Dynamic Range</div>
                    <div className="text-3xl font-bold text-white tabular-nums">{dynamicRange} <span className="text-lg font-normal text-slate-400">dB</span></div>
                 </div>
